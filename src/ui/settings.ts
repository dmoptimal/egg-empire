...
const STAT_ROWS: [string, (s: SimState) => string][] = [
  ...
  ["Birds saved mid-theft", (s) => fmt(s.stats.birdsSaved ?? 0)],
  ["Nights survived", (s) => fmt(s.stats.nights ?? 0)],
  ["Moon eggs caught", (s) => fmt(s.stats.moonEggs ?? 0)],
  ["Fireflies caught", (s) => fmt(s.stats.fireflies ?? 0)],
  ["Goodnight taps", (s) => fmt(s.stats.pets ?? 0)],
